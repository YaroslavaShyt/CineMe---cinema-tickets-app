...
class CommentDeleted extends UseCaseCommentDeleted<Type> {
  final FilmsRepository _filmsRepository;

  CommentDeleted(this._filmsRepository);
  @override
  Future<Either<AppError, IsSuccess>> call(
    String commentId,
    String localization,
  ) async =>
      _filmsRepository.getIsCommentDeleted(commentId, localization);
}
